    ...
    <div class="container">
        ...
        <form action="UpdateEventServlet" method="post">
            ...
            <div class="form-group">
                ...
                <input type="date" name="date" id="date" value="<%= request.getParameter("date") %>" required="required" style="width: 100%;"/>
			</div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="contactNumber">Music Band</label> 
			...
			<div class="form-group">
                ...
                <input type="tel" required="required" minlength="10" maxlength="10" placeholder="Ex: 07XXXXXXXX" value="<%= "0"+request.getParameter("contact") %>" name="contact" id="contact" style="width: 95%;"/>
			</div>
